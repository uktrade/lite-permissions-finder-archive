...
public class ImportEvents {
  ...
  public static final ParameterisedJourneyEvent<ImportMilitaryYesNo> IMPORT_MILITARY_YES_NO_SELECTED = new ParameterisedJourneyEvent<>("IMPORT_MILITARY_YES_NO_SELECTED", ImportMilitaryYesNo.class);
