...
public class CountryUtils {
   ...
   */
  public static List<CountryView> getFilteredCountries(Collection<CountryView> allCountries, List<String> countryRefs) {
   ...
   */
  public static List<CountryView> getFilteredCountries(Collection<CountryView> allCountries, List<String> countryRefs, boolean negate) {
  ...
  /**
   * Returns a list of Country ordered by {@link CountryView#countryName}
   *
   * @param countries countries to sort
   * @return a sorted list of countries
   */
  public static List<CountryView> getSortedCountries(Collection<CountryView> countries) {
    return countries.stream().sorted(Comparator.comparing(CountryView::getCountryName)).collect(Collectors.toList());
  }
}
